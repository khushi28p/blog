...
import { blogCategories } from '@/assets/blog_categories';
...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-primary/10 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        <p>Upload thumbnail</p>
        <label htmlFor="image">
          <img src={!image ? "/upload_area.svg" : URL.createObjectURL(image)} alt="" className='mt-2 h-16 rounded cursor-pointer' />
