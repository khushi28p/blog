...
const AnalyticsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#60A5FA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-bar-chart-2">
...
const IntegrationIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#34D399" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-code">
...
const TemplateIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#F87171" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-pen-tool">
        ...
        {features.map((feature, index) => (
          ...
          >
            <div className="md:w-1/2">
              ...
              <h3 className="mt-2 text-3xl sm:text-4xl font-bold tracking-tight text-gray-800">
                {feature.title}
              </h3>
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {cardFeatures.map((feature, index) => (
            <div
              key={index}
              className="p-8 bg-gray-100 rounded-lg shadow-xl transition-transform duration-300 hover:scale-105 hover:bg-gray-200"
            >
        ...
        <div className="mt-16 flex justify-center space-x-4">
          <button className="px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200">
            Learn More
          </button>
          <button className="px-6 py-3 border border-gray-400 text-base font-medium rounded-md text-gray-900 bg-transparent hover:bg-gray-100 transition-colors duration-200">
            Sign Up
